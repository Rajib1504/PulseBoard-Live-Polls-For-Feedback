...
export default function Footer() {
  return (
    <footer className="border-t border-border dark:border-border-dark py-8 bg-white dark:bg-card-dark mt-auto">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-muted text-sm text-center font-medium">
          &copy; {new Date().getFullYear()} PulseBoard. Built for Poll Management.
        </p>
      </div>
    </footer>
  );
